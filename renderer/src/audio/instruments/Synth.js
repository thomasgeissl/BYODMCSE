...
class Synth {
  constructor() {
    this.voices = [
      { gate: 0.0, note: 0, key: `synth-v1-${v4()}` },
      { gate: 0.0, note: 0, key: `synth-v2-${v4()}` },
      { gate: 0.0, note: 0, key: `synth-v3-${v4()}` },
      { gate: 0.0, note: 0, key: `synth-v4-${v4()}` },
      { gate: 0.0, note: 0, key: `synth-v5-${v4()}` },
